...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=r"D:\graduate_make\bus_test\yolov5-master\runs\train\exp13\weights\best.pt", help="model path(s)") ##
    parser.add_argument("--batch-size", type=int, default=8, help="batch size") ## 32
