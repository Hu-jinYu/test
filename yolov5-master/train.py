...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="", help="bus_test/yolov5-master/models/yolov5s.yaml")
    # parser.add_argument("--data", type=str, default= r"D:\graduate_make\bus_test\yolov5-master\data.yaml", help="dataset.yaml path")
    parser.add_argument("--data", type=str, default=r"D:\graduate_make\bus_test\yolov5-master\data.yaml",help="dataset.yaml path")
